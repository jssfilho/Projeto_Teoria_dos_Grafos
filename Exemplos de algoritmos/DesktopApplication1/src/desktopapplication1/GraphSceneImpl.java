...
public class GraphSceneImpl extends GraphScene<String, String> {
    ...
    public GraphSceneImpl() {
        ...
        Widget w1 = addNode("1. Red");
        w1.setPreferredLocation(new Point(10, 100));
        Widget w2 = addNode("2. Green");
        w2.setPreferredLocation(new Point(100, 250));
        Widget w3 = addNode("Blue");
    ...
    protected Widget attachNodeWidget(String arg) {
        ...
        if (arg.startsWith("1")) {  // if widget name start with 1 then use red widget
            widget.setImage(ImageUtilities.loadImage("red.gif"));
        } else if (arg.startsWith("2")) {  // if widget name start with 2 then use green widget
            widget.setImage(ImageUtilities.loadImage("green.gif"));
        } else {  // if widget name start with anything else then use blue widget
            widget.setImage(ImageUtilities.loadImage("blue.gif"));
        }
